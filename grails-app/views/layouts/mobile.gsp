...
<body>
  ...
  <div id="coopLogo"><img src="${resource(dir:'images',file:'mnclimbingcoop-web-background.png')}" alt="Minnesota Climbing Cooperative" border="0" width="320" height="48"/></div>
<g:layoutBody />
</body>
</html>