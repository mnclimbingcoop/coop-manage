    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${instrumentReceiptInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: instrumentReceiptInstance, field: 'instrument', 'errors')}">
                                    <g:select name="instrument.id" from="${coop.mnclimbing.Instrument.list()}" optionKey="id" value="${instrumentReceiptInstance?.instrument?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: instrumentReceiptInstance, field: 'person', 'errors')}">
                                    <g:select name="person.id" from="${coop.mnclimbing.Person.list()}" optionKey="id" value="${instrumentReceiptInstance?.person?.id}"  />
                                </td>
                            </tr>
